...
@Component({
  selector: 'app-fruit-matcher-level-1',
  templateUrl: './fruit-matcher-level-1.page.html',
  styleUrls: ['./fruit-matcher-level-1.page.scss'],
})
export class FruitMatcherLevel1Page implements OnInit {
