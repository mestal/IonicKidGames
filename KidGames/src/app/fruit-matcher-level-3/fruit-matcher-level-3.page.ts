...
@Component({
  selector: 'app-fruit-matcher-level-3',
  templateUrl: './fruit-matcher-level-3.page.html',
  styleUrls: ['./fruit-matcher-level-3.page.scss'],
})
export class FruitMatcherLevel3Page implements OnInit {
